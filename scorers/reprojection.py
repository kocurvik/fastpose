...
Scores pose models `[R | t]` (12 flat parameters, R row-major) against
2D-3D correspondences: the residual is the reprojection error of
Z = R X + t in calibrated image coordinates; points behind the camera are
outliers.
"""
